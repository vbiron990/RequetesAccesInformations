...
# Filtrer les données pour les types de véhicule 'Automobile', 'Camionnette' et 'VUS'
filtered_data = data[data['Type de véhicule'].isin(['Automobile', 'Camionnette', 'VUS'])]

# Filtrer les données des dommages 'Graves' et 'Mortels' pour ces types de véhicule
dommages_graves_filtres = dommages_graves[dommages_graves['Type de véhicule'].isin(['Automobile', 'Camionnette', 'VUS'])]
dommages_mortels_filtres = dommages_mortels[dommages_mortels['Type de véhicule'].isin(['Automobile', 'Camionnette', 'VUS'])]
...
plt.savefig('graph_type_vehicule.png')
